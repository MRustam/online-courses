...
//    @PatchMapping("/fetch/{id}")
//    public ResponseEntity<Instructor> fetch(@PathVariable Long id, @RequestBody Instructor instructor) {
//        if (id <= 0 & instructor == null) {
//            return new ResponseEntity<>(null, HttpStatus.NOT_ACCEPTABLE);
//        }
//        return new ResponseEntity<>(instructorService.fetch(id, instructor), HttpStatus.OK);
//    }

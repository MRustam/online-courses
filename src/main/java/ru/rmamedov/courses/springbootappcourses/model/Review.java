...
public class Review {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "course_review_generator")
    @SequenceGenerator(name = "course_review_generator", sequenceName = "course_review_id_seq", allocationSize = 1)
    private Long id;

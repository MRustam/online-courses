...
INSERT INTO course (title, category, description, duration, start_date, instructor_id)
VALUES ('Java 7EE', 'programming', 'For not beginners.', 35, '2018-03-01', 1);
INSERT INTO course (title, category, description, duration, start_date, instructor_id)
VALUES ('C#', 'programming', 'For beginners.', 45, '2018-05-10', 1);
INSERT INTO course (title, category, description, duration, start_date, instructor_id)
VALUES ('Java 8SE', 'programming', 'For advanced.', 15, '2018-04-20', 1);
INSERT INTO course (title, category, description, duration, start_date, instructor_id)
VALUES ('English for every one', 'languages', 'pre-intermediate', 65, '2018-03-11', 1);
INSERT INTO course (title, category, description, duration, start_date, instructor_id)
VALUES ('Germany', 'languages', 'For beginners.', 45, '2018-06-01', 1);
INSERT INTO course (title, category, description, duration, start_date, instructor_id)
VALUES ('Swift', 'programming', 'Advanced', 100, '2018-06-21', 1);
INSERT INTO course (title, category, description, duration, start_date, instructor_id)
VALUES ('C', 'programming', 'Only for beginners.', 29, '2018-05-31', 1);
INSERT INTO course (title, category, description, duration, start_date, instructor_id)
VALUES ('Play guitar', 'hobby', 'For beginners.', 20, '2018-04-10', 1);
INSERT INTO course (title, category, description, duration, start_date, instructor_id)
VALUES ('English for advanced', 'languages', 'upper-intermediate', 55, '2018-08-19', 1);
INSERT INTO course (title, category, description, duration, start_date, instructor_id)
VALUES ('Spain', 'languages', 'For intermediate.', 70, '2018-02-02', 1);
--
